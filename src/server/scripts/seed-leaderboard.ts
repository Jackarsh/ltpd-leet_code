...
export async function seedLeaderboardData() {
  ...
  const mockStudents = [
    ...
    // Dummy users for testing UI
    {
      email: "dummy1.male@college.edu",
      name: "Dummy Male One",
      handle: "dummy_m1",
      branch: "CSE",
      admYear: 2023,
    ...
    {
      email: "dummy3.male@college.edu",
      name: "Dummy Male Three",
      handle: "dummy_m3",
      branch: "ECE",
      admYear: 2024,
      gradYear: 2028,
    ...
    {
      email: "dummy1.female@college.edu",
      name: "Dummy Female One",
      handle: "dummy_f1",
      branch: "CSE",
      admYear: 2023,
      gradYear: 2027,
    ...
    {
      email: "dummy2.female@college.edu",
      name: "Dummy Female Two",
      handle: "dummy_f2",
      branch: "IT",
      admYear: 2022,
      gradYear: 2026,
    ...
    {
      email: "dummy3.female@college.edu",
      name: "Dummy Female Three",
      handle: "dummy_f3",
      branch: "ECE",
      admYear: 2024,
      gradYear: 2028,
